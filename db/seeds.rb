...
users = User.create([
  {id: 9, username: "qeugens", email: "qeugens@hse.ru", isadmin: true, description: "я убью себя самого", avatar: URI.open("https://github.com/qeugens/stuchkiss/blob/main/public/images/avatarMasha.png?raw=true"), password: "yourPassWord"}
  ])
